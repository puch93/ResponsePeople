...
import kr.co.core.responsepeople.dialog.QuestionResponseDlg;
import kr.co.core.responsepeople.util.Common;

public class AlarmResponseAdapter extends RecyclerView.Adapter<AlarmResponseAdapter.ViewHolder> {
    private Activity act;
    ArrayList<ArrayList<QuestionReceivedData>> list = new ArrayList<>();

    public AlarmResponseAdapter(Activity act, ArrayList<ArrayList<QuestionReceivedData>> list) {
        this.act = act;
        this.list = list;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_question_alarm_response, parent, false);
        return new AlarmResponseAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int i) {
        ...
        holder.btn_response.setOnClickListener(v -> {
            act.startActivity(new Intent(act, QuestionResponseDlg.class).putExtra("list", list.get(i)));
        });
    }
