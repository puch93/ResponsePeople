...
//    //채팅타입
    ...
    public static final String SETROOMREADIS ="setRoomReadIs";
    public static final String LASTCHATCONTENTS = "lastChatContents";
    public static final String SETCHATSAVE = "setChatSave";
    public static final String TEMPQUIT = "tempQuit";
    public static final String SETROOMOUT = "setRoomOut";
}
