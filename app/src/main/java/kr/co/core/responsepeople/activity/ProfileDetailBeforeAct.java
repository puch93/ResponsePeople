...
import kr.co.core.responsepeople.databinding.ActivityProfileDetailBeforeBinding;
...
public class ProfileDetailBeforeAct extends BaseAct implements View.OnClickListener {
    ActivityProfileDetailBeforeBinding binding;
    Activity act;
    String type;
    String y_idx;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_profile_detail_before, null);
        act = this;
