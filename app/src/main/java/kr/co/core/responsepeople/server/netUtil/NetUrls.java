...
public class NetUrls {
    public static final String DOMAIN = "https://qnating.adamstore.co.kr/lib/control.siso";
    public static final String DOMAIN_ORIGIN = "https://qnating.adamstore.co.kr";
    public static final String TERM = "setMobileDomain"; // 약관 가져오기
    public static final String VERSION = "versionchk"; // 버전체크
